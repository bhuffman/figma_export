...
function generatePrismaSchemaFromNestedObjectDirectly(nestedObject) {
    ...
    function traverseObject(obj, modelName, parentName = null) {
...
function generateNestedObject(fields) {
